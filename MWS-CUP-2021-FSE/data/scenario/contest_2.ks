[_tb_system_call storage=system/_contest_2.ks]
...
[freeimage layer = 1 time= "0"]
[if exp = "f.A_name == '藤原コーポレーション']
[jump storage = "contest_2.ks" target = "*win"]
[endif]
...
[chara_hide  name="同僚"  time="0"  wait="false"  pos_mode="true"  ]
[tb_image_hide  time="0"  ]
[jump  storage="contest_2.ks"  target="*end"  ]
*win
...
[tb_start_tyrano_code]
;ライバル社の精度更新
[eval exp = "f.A_AI_seido = 80"]
[eval exp = "f.B_AI_seido = 50"]
[eval exp = "f.C_AI_seido = 20"]
