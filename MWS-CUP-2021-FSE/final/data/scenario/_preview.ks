...
AI２号機のモデル抽出に対する防御率は[emb exp="f.AI_bougyo_2_query"]に上昇した！[p]
[elsif exp="f.AI_bougyo_3_query = f.AI_bougyo_3_query + f.item_Au_rise"]
AI３号機のモデル抽出に対する防御率は[emb exp="f.AI_bougyo_3_query"]に上昇した！[p]
[endif]
...
[elsif exp="f.AI_bougyo_3_filtering = f.AI_bougyo_3_filtering + f.item_Cu_rise"]
...
AI２号機の敵対的サンプルに対する防御率は[emb exp="f.AI_bougyo_2_filtering"]に上昇した！[p]
[elsif exp="f.AI_bougyo_3_filtering = f.AI_bougyo_3_filtering + f.item_Ag_rise"]
AI３号機の敵対的サンプルに対する防御率は[emb exp="f.AI_bougyo_3_filtering"]に上昇した！[p]
[endif]
...
AI２号機の敵対的サンプルに対する防御率は[emb exp="f.AI_bougyo_2_filtering"]に上昇した！[p]
[elsif exp="f.AI_bougyo_3_filtering = f.AI_bougyo_3_filtering + f.item_Au_rise"]
AI３号機の敵対的サンプルに対する防御率は[emb exp="f.AI_bougyo_3_filtering"]に上昇した！[p]
[endif]
...
[elsif exp="f.AI_bougyo_3_noise = f.AI_bougyo_3_noise + f.item_Cu_rise"]
...
AI２号機のデータ復元に対する防御率は[emb exp="f.AI_bougyo_2_noise"]に上昇した！[p]
[elsif exp="f.AI_bougyo_3_noise = f.AI_bougyo_3_noise + f.item_Ag_rise"]
AI３号機のデータ復元に対する防御率は[emb exp="f.AI_bougyo_3_noise"]に上昇した！[p]
[endif]
...
AI２号機のデータ復元に対する防御率は[emb exp="f.AI_bougyo_2_noise"]に上昇した！[p]
[elsif exp="f.AI_bougyo_3_noise = f.AI_bougyo_3_noise + f.item_Au_rise"]
AI３号機のデータ復元に対する防御率は[emb exp="f.AI_bougyo_3_noise"]に上昇した！[p]
[endif]
