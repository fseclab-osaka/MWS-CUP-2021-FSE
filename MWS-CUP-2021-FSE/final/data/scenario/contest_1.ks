[_tb_system_call storage=system/_contest_1.ks]
...
#一条尊
[er]よう、[emb exp = "f.name"]。お前もこのコンテストに参加するのか。[r][p]
今日は試作品なんだが、せいぜい楽しませてくれよ。[r][p]
張り合う相手がいないと面白くないだろう？[r][p]
#
[_tb_end_text]
...
[tb_image_show  time="0"  x="3"  y="412"  storage="default/顔/顔_同僚_C.png"  width="230"  height="225"  name="img_11"  ]
[tb_start_text mode=1 ]
#同僚
[er]はなにつくでやんすね。こっちもまだテスト段階でやんすよ？[r][p]
#
[_tb_end_text]
...
[tb_image_show  time="0"  storage="default/顔/顔_司会者_通常.png"  width="230"  height="225"  x="3"  y="412"  name="img_20"  ]
[tb_start_text mode=1 ]
#司会者
[er]さて、始まりました！　AIコンテスト！！！[r] [p]
今回を含めてコンテストは全4回！　各回のコンテストで上位２チームには賞金が出ます！[r][p]
そして、最終コンテストの優勝賞金はなんと、１億G！！！！ [r][p]
とんだ賞金額です！　最終コンテストに向けて、それまでの３回のコンテストで存分に力試しができます！最終コンテストでの優勝目指して頑張ってくださいね！[r] [p]
今回の参加者は、東郷グループ、田手エレクトロニクス、島山カンパニー、藤原コーポレーションの４社です。[p]
そして、今回の賞金は１位１００万G、２位５０万Gとなります！[p]
さらに、副賞としてアイテムがついています！[r] [p]
では、さっそく始めましょう！[r][p]
[_tb_end_text]
...
[if exp = "f.A_name == '藤原コーポレーション']
[jump storage = "contest_1.ks" target = "*win"]
[endif]

[_tb_end_tyrano_code]

[chara_show  name="ライバル"  time="0"  wait="false"  storage="chara/4/ライバル_2.png"  width="476"  height="715"  left="480"  top="-78"  reflect="false"  ]
[tb_image_show  time="0"  storage="default/顔/顔_ライバル_2.png"  width="230"  height="225"  x="3"  y="412"  name="img_33"  ]
[tb_start_text mode=1 ]
#一条尊
この程度か。じゃあな。[r][p]
#
...
[chara_hide  name="ライバル"  time="0"  wait="false"  pos_mode="true"  ]
[tb_image_hide  time="0"  ]
[chara_show  name="同僚"  time="0"  wait="false"  storage="chara/2/同僚_B.png"  width="447"  height="633"  left="228"  top="7"  reflect="false"  ]
[tb_image_show  time="0"  x="3"  y="412"  storage="default/顔/顔_同僚_B.png"  width="230"  height="225"  name="img_38"  ]
[tb_start_text mode=1 ]
#同僚
[er]くぅ〜〜〜、くやしいでやんす！！[r]次は頑張るでやんすよ！[r][p]
#
[_tb_end_text]

[chara_hide  name="同僚"  time="0"  wait="false"  pos_mode="true"  ]
[tb_image_hide  time="0"  ]
[jump  storage="contest_1.ks"  target="*end"  ]
*win

[chara_show  name="ライバル"  time=""  wait="false"  storage="chara/4/ライバル_2.png"  width="476"  height="715"  left="480"  top="-78"  reflect="false"  ]
[tb_image_show  time="0"  storage="default/顔/顔_ライバル_2.png"  width="230"  height="225"  x="3"  y="412"  name="img_45"  ]
[tb_start_text mode=1 ]
#一条尊
...
[chara_show  name="同僚"  time="0"  wait="false"  storage="chara/2/同僚_A.png"  width="447"  height="633"  left="228"  top="7"  reflect="false"  ]
...
[eval exp = " f.contest = 7"]
[eval exp = "f.afternoon = 0"]
[_tb_end_tyrano_code]

[jump  storage="meeting_her_again_2.ks"  target=""  ]
[s  ]
